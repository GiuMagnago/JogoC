...
class Personagens {
    private:
        ...
        //funções de ações
        int escolheArma(int forcaF, int cod_arma);
        int escolheMagia(int &pontosV, int &pontosM, int forcaM, int cod_magia);
        int calculaEsquiva(int agil);
        ...
        void pocaoVida(int &pontosV, int &pontosM); //posição "0" no vetor, valor "1"
        int halitoFogo(int &pontosM); //posição "1" no vetor, valor "2"
        int bio(int &pontosM); //posição "2" no vetor, valor "3"
        void cura(int &pontosV, int &pontosM); //posição "3" no vetor, valor "4"
        int flamaGelada(int &pontosM); //posição "4" no vetor, valor "5"
        int intoxicacao(int &pontosM); //posição "5" no vetor, valor "6"
        int tempestade(int &pontosM); //posição "6" no vetor, valor "7"
    ...
    public:
        ...
        void recebeDano(int danoAtaque, int danoMagia, int &pontosV, int armor, int resist, int agil);
